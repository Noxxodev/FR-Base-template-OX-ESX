...
Config.Hospitals = {
	["phillbox"] = {
		paramedic = {
			...
			pos = vector4(305.03, -595.81, 42.28, 338.7213),
		},
		bossmenu = {
			pos = vector3(334.76, -594.29, 43.28),
			min_grade = 3
		},
		zone = {
		...
		respawn = {
			{
				bedPoint = vector4(319.33, -581.01, 44.19, 150.04),
				spawnPoint = vector4(320.25, -581.48, 42.28, 68.24)
			},
			-- {
		...
		stash = {
			['ems_stash_1'] = {
				...
				pos = vector3(310.15, -568.47, 43.28)
			}
		},
		pharmacy = {
			["ems_shop_1"] = {
				...
				pos = vector3(311.67, -564.13, 43.28),
				blip = {
					enable = false,
					name = 'Pharmacie',
					type = 61,
		...
		clothes = {
			enable = true,
			pos = vector4(300.90, -600.54, 42.28, 340.0),
